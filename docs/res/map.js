            ...
            data.forEach(function(row) {
                ...
                if (row.FLT_TOT_1_ORIG && row.FLT_TOT_1_NORMALIZED){
                    ...
                    if (parseInt(row.YEAR) === year1) {
                        ...
                        circle1.addTo(map) // TODO: add smaller circle for binding
                            .bindPopup(document.getElementById('chart-div-' + row.APT_IATA), { maxHeight: 300, maxWidth: 400, minHeight: 300, minWidth: 400 })
                            .openPopup()
                            .closePopup();
                        ...
                        // Add circle to panes data and map
                        circle2.addTo(map) // TODO: add smaller circle for binding
                            .bindPopup(document.getElementById('chart-div-' + row.APT_IATA), { maxHeight: 300, maxWidth: 400, minHeight: 300, minWidth: 400 })
                            .openPopup()
                            .closePopup();
