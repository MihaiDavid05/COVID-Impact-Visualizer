...
- A fixed-at-the-top navigation bar with four links (Summary, Cases, Employment, and Flights; additionaly an external link to the git repo) that serves as the menu with shortcuts for the four sections of our website. ![Menu](/screenshots/menu.png)
